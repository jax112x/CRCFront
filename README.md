...
A webpage hosted on AWS that tracks and displays the number of visitors. This repository is for the frontend files. Repository for the backend files can be found [here](https://github.com/jax112x/CRCBack).
